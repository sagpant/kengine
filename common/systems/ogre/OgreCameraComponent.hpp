...
#include <putils/pogre/CameraMan.hpp>
#include <OGRE/Ogre.h>
...
public:
    Ogre::SceneNode& getNode() noexcept
    { return *_strategy.getCamNode(); }

    const Ogre::SceneNode& getNode() const noexcept
    { return *_strategy.getCamNode(); }
