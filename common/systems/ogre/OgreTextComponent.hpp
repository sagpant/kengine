...
public:
    ...
    { _text.setCaption(text.data()); }

    void setPosition(const putils::Point3d& pos)
    { _node.setPosition((float)pos.x, (float)pos.y, (float)pos.z); }

public:
    Ogre::MovableText& getText()
    { return _text; }

    const Ogre::MovableText& getText() const
    { return _text; }
